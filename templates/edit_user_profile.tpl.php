...
*					</td>
					<td>
					<select name="usertype" class="inputbox">
						{GROUP}
					</select>
					</td>
				</tr>
					...
					<tr>
						...
						<td>
					<textarea class="inputbox" name="interests" cols="40" rows="">{INTERESTS}</textarea>						</td>
					</tr>
					<tr>
						<td>
						Home address:
						...
						<td>
						<textarea class="inputbox" name="homeaddress" cols="40" rows="">{HOMEADDRESS}</textarea>		
						</td>
					</tr>
