		...
		<tr>
			<td width="100%"  valign="top">
				<table width="100%" cellspacing="0" border="0"  >
                  ...
                  <tr> 
                    <td width="390"> Client Name:* </td>
                    <td width="1244"> <input type="text" name="clientname" class="inputbox" size="40" value="{CLIENTNAME}" /> 
                    </td>
                  </tr>
                  <tr> 
                    <td> Contact name : *</td>
                  ...
                  <tr> 
                    ...
                    <td> Password : *<p style="font-size:10px; line-height:1em; margin:0 0 0 0; color:#FF0000;">You only need to supply a password if you want to change it</td>
                    <td valign="top"> 
                  ...
                  <tr> 
                    ...
                    <td valign="top"> <input type="password" name="password2" class="inputbox" size="40" value="" /> 
                    </td>
                  <tr>
                  ...
                  <tr> 
                    <td> Contact No: *</td>
                    <td> <input  type="text" name="phoneno" class="inputbox"size="40" value="{PHONENO}" /> 
                    </td>
                  </tr>
                  <tr> 
                    <td> Extra info : </td>
                    <td> <textarea name="extrainfo" class="inputbox" cols="42" rows="">{EXTRAINFO}</textarea>	
                    </td>
                  </tr>
                  <tr> 
                    <td> Enabled : </td>
                  ...
                  <tr> 
                    <td valign="top">Last Visit Date :  </td>
