				...
				<h3 class="msginfo">{MESSAGE}</h3>
					...
					<input type="hidden" name="boxchecked" value="0" />
						<div id="toolbar_panel">
							...
							<div id="toolbar_btn">
							<a href="feedback_manager.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../admin/images/edit_f2.png',1)"><img src="../admin/images/edit.png" name="Image3" width="32" height="32" border="0">Refresh</a>
							</div>							
						</div>
					
					<h1 class="asterisk">Feedback/Comments</h1>
