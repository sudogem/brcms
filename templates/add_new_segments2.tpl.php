...
<script language="javascript" type="text/javascript">
	...
	function submitbutton(pressbutton){
		...
		if (f.title.value == "" ) {
			...
			switch(pressbutton){
				case 'saveasdraft':
					var ans = confirm("Are you sure you want to publish the segment?");
					if (ans == true) {
		...
		<div id="container">
			...
			<form name="adminForm" id="adminForm"  method="post" action="../admin/save_segment.php" >
				...
				<div id="toolbar_panel">
					...
					<div id="toolbar_btn">
						<a href="#"  onClick="submitbutton('saveasdraft');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../admin/images/publish_f2.png',1)"><img src="../admin/images/publish.png" name="Image4" width="32" height="32" align="absmiddle" border="0">Publish to Page </a>						
					</div>
					
					
			  </div>
				<table width="100%" border="0" class="ctable4">
				<h1 class="asterisk">Segment: New</h1>	

					<tr>
					  <td colspan="4" class="table_header" >Details</td>
			  </tr>
					<tr>
						<td width="71" class="caption3"><strong>Segment Title:</strong></td> 
						<td width="498"><input name="segmentTitle"  type="text" value="" size="50" class="inputbox"></td>
						<td width="10">&nbsp;</td>
						<td width="266" rowspan="10">
				<div id="imagepanel2">
				  <p class="orange">&nbsp;&nbsp;<b>Uploaded images:</b></p><br>
					...
					<tr>
					  ...
					  <td><input name="segmentTopic"  type="text" value="" size="80" class="inputbox"></td>
					  <td></td>
			  </tr>
					<tr>
					  <td class="caption3"><strong>Segment Anchor:</strong></td>
					  <td><input name="segmentAnchor"   type="text" value="" size="80" class="inputbox"></td>
					  <td></td>
			  </tr>
					<tr>
						<td class="caption3"><strong>Segment Schedule:</strong></td>      
						<td><input name="segmentSchedule"  type="text" value="" size="80" class="inputbox"></td>
						<td></td>
					</tr>
