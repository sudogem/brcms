...
<table width="100%" border="0" class="midpanel" >
  <tr>
    <td width="50%" rowspan="2" class="asterisk">Messaging Archive Manager</td>
    <td width="70%">
		<!-- <div align="right">
		...
		<!-- <div align="right"><b>Filter Article title : </b>
			<input name="filter_text" type="text" class="inputbox"  onChange="document.adminForm.submit();" value="{FILTER_TEXT}" size="21" > 
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ctable2">
									...
									<td width="6%" class="tdcaptions"><input type="checkbox" name="toggle" value="" onClick="checkAll({NUMITEMS});" > </td>
									<td width="26%" class="tdcaptions">{MESSAGE_SUBJECT}</td>
									<td width="14%" class="tdcaptions">{FROM}</td>
									<td width="25%" class="tdcaptions">{DATE}</td>
									<td width="24%" class="tdcaptions">{DATE_DELETED}</td>
									</tr>
								  {TABLE_DATA}
									<tr class="table_header">
