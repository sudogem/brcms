		...
		<div id="container">
			...
			<form name="adminForm" id="adminForm"  method="post" action="../admin/save_ader_site_content.php"  >
				...
				<div id="toolbar_panel">
					...
					<div id="toolbar_btn">
						<a href="#"  onClick="submitbutton('update');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../admin/images/save_f2.png',1)"><img src="../admin/images/save.png" name="Image4" width="32" height="32" align="absmiddle" border="0">Save</a>						
					</div>
			  </div>
				<table width="100%" border="0" class="ctable4">
                  ...
                  <tr>
                    ...
                    <td><input type="checkbox" name="ispublished" value="1" {ischecked}></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
