			...
			<div id="content">
				<h3 class="msginfo">{MESSAGE}</h3>
					...
					<div id="toolbar_panel">
						<div id="toolbar_btn">
							<a href="#" onClick="return confirmdelete();"    onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('delete','','../admin/images/delete_f2.png',1)"><img src="../admin/images/delete.png" name="delete" width="32" height="32" border="0">Delete</a>						
						</div>
					 </div> 
							<h1 class="asterisk">My Banners </h1>						
				    		<table width="100%" class="ctable">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ctable2">
									...
									<td width="25%" class="tdcaptions">{BANNER_NAME}</td>
									<td width="25%" class="tdcaptions">{BANNER_SIZE}</td>									
									<td width="10%" class="tdcaptions">{BANNER_STATUS}</td>
									<td width="20%" class="tdcaptions">{IMPRESSIONS_PURCHASED}</td>
									<td width="15%" class="tdcaptions">{IMPRESSIONS_MADE}</td>									
									<td width="15%" class="tdcaptions">{IMPRESSIONS_LEFT}</td>
									<td width="10%" class="tdcaptions">{CLICKS}</td>
									</tr>
								  {TABLE_DATA}
									<tr class="table_header">
