...
function enableSegments() {
		...
		if(document.adminForm.category.value == "12") {
			document.adminForm.segmentTitle.disabled = false;
			document.adminForm.segmentAnchor.disabled = false;
			document.adminForm.segmentSchedule.disabled = false;
			document.Image4x.disabled = false;
			//document.adminForm.segmentDate.disabled = false;
		} else {
			 disableSegments();
		}
	}
	...
	function disableSegments() {
		//alert("Hello World..");
		document.adminForm.segmentTitle.disabled = true;
		document.adminForm.segmentAnchor.disabled = true;
		document.adminForm.segmentSchedule.disabled = true;
		document.Image4x.disabled = true;
		//document.adminForm.segmentDate.disabled = true;
	}
</script>
...
<div id="wrapper">
		<div id="container">
			...
			<div id="outerpanelx">
				...
				<div id="panel2">
			<form name="adminForm" id="adminForm"  method="post" action="../admin/save_segment.php"  >
				...
				<div id="toolbar_panel">
					...
					<div id="toolbar_btn">
						<a href="#"  onClick="submitbutton('saveasdraft');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../admin/images/save_f2.png',1)"><img src="../admin/images/save.png" name="Image4" width="32" height="32" align="absmiddle" border="0">Publish To Page</a>						
					</div>
				</div>
<table width="100%" border="0" class="ctable4">
				<h1 class="asterisk">Content Item: New</h1>	
					...
					<tr>
						<td width="227" class="caption3"><strong>Segment Title:</strong></td> 
						<td width="542"><input name="segmentTitle"  type="text" value="{TITLE}" size="50" class="inputbox"></td>
						<td width="40">&nbsp;</td>
						<td width="266" rowspan="7">
				<div id="imagepanel2">
				...
				<tr>
						<td class="caption3"><strong>Segment Topic:</strong></td>      
						<td><input name="segmentTopic"  type="text" value="{SEGMENTTITLE}" size="80" class="inputbox"></td>
						<td></td>
				</tr>
				
				<tr>
						<td class="caption3"><strong>Segment Anchor:</strong></td>      
						<td><input name="segmentAnchor"   type="text" value="{SEGMENTANCHOR}" size="80" class="inputbox"></td>
						<td></td>
				</tr>
				
				<tr>
						<td class="caption3"><strong>Segment Schedule:</strong></td>      
						<td><input name="segmentSchedule"  type="text" value="{SEGMENTSCHEDULE}" size="80" class="inputbox"></td>
						<td></td>
				</tr>
				<tr> 
