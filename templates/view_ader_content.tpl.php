				...
				<div id="outerpanel">
					<div id="panel">
								<div id="toolbar_panel">
									<div id="toolbar_btn">
										<a href="../admin/edit_other_content.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('editbtn','','../admin/images/edit_f2.png',1)"><img src="../admin/images/edit.png" name="editbtn" width="32" height="32" align="absmiddle" border="0">Edit</a>						
									</div>
									<div id="toolbar_btn">
								...
								<tr>
								<td width="12%" class="caption2">Title : </td>
								<td class="data">
								{TITLE}
								...
								<tr>
								<td class="caption2" valign="top"> Body : </td>
								<td class="data" width="80%">{BODY}</td>								
								</tr>
								</table>
			<div class="clear"></div>					
			        </div>
