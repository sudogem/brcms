...
<script type="text/javascript" language="javascript">
	function mh(){
		...
		if ( f.quote.value == "" ){
			alert( "You must provide a quote title." );
			return false;
		}
		if ( f.author.value == "" ){
			...
			<div id="content">
				<div id="outerpanel">
					...
					<div id="toolbar_panel">
						...
						<h1 class="asterisk">Quote: New </h1>
					...
					*					</td>
									  <td width="240">
										<textarea class="inputbox" name="quote" cols="30" rows="10"></textarea>
										</td>
									</tr>
									<tr>
										<td>
										Author : * </td>
										<td><input type="text" name="author" class="inputbox" size="40" value="anonymous" />
										</td>
