...
<script type="text/javascript" language="javascript">
	function ispublish(){
		var ans = confirm("Are you sure you want to publish the article?");
		if (ans == true) {
			return true;
		}else return false;
	}
			...
			<div id="content">
				<div id="outerpanel">
						...
						<div id="toolbar_panel">
							<div id="toolbar_btn">
								<a href="../admin/view_article_versions.php?stageID=5" onClick="document.adminForm.submit();return true;" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../admin/images/publish_f2.png',1)"><img src="../admin/images/publish.png" name="Image1" width="32" height="32" border="0" align="absmiddle">Close</a>				
							</div>

							<div id="toolbar_btn">
								<a href="../admin/publish_article.php" onClick="return ispublish();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../admin/images/publish_f2.png',1)"><img src="../admin/images/publish.png" name="Image2" width="32" height="32" border="0" align="absmiddle">Publish</a>				
							</div>
							<div id="toolbar_btn">
