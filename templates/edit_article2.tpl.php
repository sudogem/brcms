...
<script language="javascript" type="text/javascript">
	...
	function submitbutton(pressbutton){
		...
		else if (f.elm1.value == "" ) {
			alert( "You need to enter a body of the article." );
			return false;
		}
		...
		<div id="container">
			...
			<form name="adminForm" id="adminForm"  method="post" action="../admin/save.php"  >
				...
				<div id="toolbar_panel">
					...
					<div id="toolbar_btn">
						<a href="#" onClick="popupWindow('../admin/popups/uploadimage4.php','win1',300,300,'no','yes');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('savebtn','','../admin/images/upload_f2.png',1)"><img src="../admin/images/upload.png" name="savebtn" width="32" height="32" align="absmiddle" border="0">Upload image</a>						
					</div>
					<div id="toolbar_btn">
...
<table width="100%" border="0" class="ctable4">
				<h1 class="asterisk">Content Item: Edit</h1>	
					...
					<tr>
						...
						<td width="273"><input name="title" class="inputbox" value="{ARTICLE_TITLE}" size="80"></td>
						<td width="56">&nbsp;</td>
