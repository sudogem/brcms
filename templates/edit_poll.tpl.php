...
<body>
	<div id="wrapper">
		<div id="container">
			...
			<div id="content">
					<div id="panel" >
				<form name="users" method="post" action="save_poll.php" >
					...
					<h1 class="asterisk">Poll : Edit </h1>
		...
		<tr>
			<td   valign="top">
				...
				<tr>
					...
					Topic:
*					</td>
					<td width="334"><textarea name="topic" cols="20" rows="5" class="inputbox">{TOPIC}</textarea></td>
					<td width="601">
<table border="0">
			<tr>
			...
			<tr>
				...
				<tr>
				  ...
				  <td><textarea name="label" class="inputbox" cols="20" rows="5">{RESPOND_LABELS}</textarea></td>
				  <td>&nbsp;</td>
				  <tr>
					<td>&nbsp;					</td>
					<td>&nbsp;</td>
