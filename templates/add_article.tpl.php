		...
		<div id="container">
			...
			<form name="adminForm" id="adminForm" onSubmit="return validate();" method="post" action="save.php"  >
				...
				<div id="toolbar_panel">
					...
					<div id="toolbar_btn">
						<a href="#" onClick="document.adminForm.submit();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../admin/images/save_f2.png',1)"><img src="../admin/images/save.png" name="Image4" width="32" height="32" align="absmiddle" border="0">Save as draft</a>						
					</div>
					<div id="toolbar_btn">
						<a href="#" onClick="document.adminForm.submit();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4x','','../admin/images/save_f2.png',1)"><img src="../admin/images/save.png" name="Image4x" width="32" height="32" align="absmiddle" border="0">Submit to News Editor</a>						
					</div>					
			...
			<!-- <div id="editor1"> -->
				<!-- Article Information -->
				<table width="590" border="0" class="ctable2">
					<tr>
						<td width="100" class="caption2"><strong>Article Title:</strong></td> 
						<td width="273"><input name="title" value="{TITLE}" size="60"></td>
						<td width="56">&nbsp;</td>
					</tr>
					...
					<tr>
						...
						<td colspan="2">
							<script type="text/javascript">
								var editor = new WYSIWYG_Editor('editor', '', '.', 600, '', 'style.css', '' );
								editor.display();
							</script>
						</td>
					</tr>
