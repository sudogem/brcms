			...
			<div id="content">
				<div id="outerpanel">
					...
					<h3 class="msginfo">{MESSAGE}</h3>	
						<h1 class="asterisk">Tasks : New</h1>
							...
							<tr>
							  <td valign="top">							  <table width="100%" class="ctable" id="tdata"  cellspacing="0" border="0"  >
                                <tr class="table_header" >
                                  <th colspan="4" align="left" class="tdcaptions"> Details </th>
                                </tr>
                                <tr>
                                  <td colspan="102"> <span class="hsmall">Items marked with a * are required unless stated otherwise.</span> </td>
                                </tr>
                                <tr>
                                  <td width="170"> Subject : * </td>
                                  <td width="354">
                                    <input type="text" name="subject" class="inputbox" size="40" value="" />
                                  </td>
                                  <td width="1696" rowspan="10" valign="top">
                                ...
                                <tr valign="top">
                                  ...
                                  <td valign="top">
                                    <textarea name="description" cols="42" class="inputbox" rows="10"></textarea>
                                  </td>
                                </tr>
                                <tr valign="top">
