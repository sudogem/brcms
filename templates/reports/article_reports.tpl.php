...
<body>
	<div id="wrapper">
		<div id="container">
			...
			<div id="content">
					<div id="panel">
					<form name="users" method="post" action="article_reports.php" >
					...
					<h1 class="asterisk">Article Reports</h1>
					<table width="100%" border="0" >
					  ...
					  <tr>
						<td>&nbsp;</td>
						<td width="200"><input name="approved" type="checkbox" value="approved" {APPROVED} >
					Approved Articles </td>
						<td width="19">&nbsp;</td>
						<td width="125">Select Month:</td>
						<td width="100">Select Year: </td>
						<td width="282">&nbsp;</td>
					  </tr>
					  <tr>
					    <td>&nbsp;</td>
					    <td><input name="rejected" type="checkbox" value="rejected" {REJECTED}>
					Rejected Articles </td>
					    <td>&nbsp;</td>
					...
					<table width="100%" border="0" cellpadding="4" cellspacing="0" class="ctable2">
					  <tr class="table_header"  align="left">
						...
						<td width="15%" class="tdcaptions">{EDITED_BY}</td>		
						<td width="15%" class="tdcaptions">{DATE_WRITTEN}</td>
						<td width="17%" class="tdcaptions">{LAST_MODIFIED}</td>
