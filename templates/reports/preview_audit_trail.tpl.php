...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ctable3">
	...
	<td width="17%" class="rpt_caption">{USERNAME}</td>
	<td width="18%" class="rpt_caption">{ACTION}</td>
	<td width="34%" class="rpt_caption">{ITEMNAME}</td>									
	<td width="16%" class="rpt_caption">{DATE}</td>									
	<td width="12%" class="rpt_caption">{TIME}</td>
	</tr>
  {TABLE_DATA}
</table>  
</div>
