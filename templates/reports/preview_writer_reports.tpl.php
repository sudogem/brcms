...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ctable3" >
	...
	<td width="2%" >#</td>
	<td width="25%" class="rpt_caption">{ARTICLE_TITLE}</td>
	<td width="19%" class="rpt_caption">{CATEGORY}</td>
	<td width="20%" class="rpt_caption">{STAGEID}</td>
	<td width="25%" class="rpt_caption">{DATE_CREATED}</td>
	</tr>
	{TABLE_DATA}
</table>	
</div>
