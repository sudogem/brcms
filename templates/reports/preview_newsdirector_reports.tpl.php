...
<html>
<head>
<title>News Director Report</title>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" class="ctable3">
  <tr class="report_header1"  align="left">
	<td width="2%" class="rpt_caption">#</td>
	<td width="20%" class="rpt_caption">{ARTICLE_TITLE}</td>
	<td width="15%" class="rpt_caption">{CATEGORY}</td>	
	<td width="15%" class="rpt_caption">{WRITTEN_BY}</td>
	<td width="15%" class="rpt_caption">{EDITED_BY}</td>		
	<td width="15%" class="rpt_caption">{DATE_WRITTEN}</td>
	<td width="17%" class="rpt_caption">{LAST_MODIFIED}</td>
	<td width="10%" class="rpt_caption">{STATUS}</td>
  </tr>
  {TABLE_DATA}
</table>  
</div>
