...
<table width="100%" border="0" style="float:left; " >
					  ...
					  <tr>
					    <td>&nbsp;</td>
					    <td colspan="5" class="asterisk">Writer Report</td>
		    </tr>
					  <tr>
						<td>&nbsp;</td>
					  ...
					  <tr>
					    <td>&nbsp;</td>
					    <td><select name="month" class="inputbox">
					    ...
					    <td>&nbsp;</td>
					    <td><select name="year" class="inputbox">
							{LISTOFYEAR}
				        </select></td>
					  ...
					  <tr>
						...
						<td colspan="5">&nbsp;</td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ctable2">
									...
									<td width="20%" class="tdcaptions">{STAGEID}</td>
