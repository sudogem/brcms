...
$link = "download_doc.php?articleID=" . intval( $view_article[0]->articleID );
...
$tags = array(
		...
		'{TITLE}' 				=> $view_article[0]->title ,
		'{AUTHOR}' 				=> getArticle_authors_info( $view_article[0]->articleID, 'fullname' )  . '</p>' ,
		'{ARTICLE_BODY}' 		=> $view_article[0]->article_body ,
