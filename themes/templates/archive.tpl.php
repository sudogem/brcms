...
<body>
<div id="wrapper">
	<div id="header"><pre class="searchpos"><form name="" method="post" action="search_results.php"><span class="whitetext"><b>Search::</b></span><input name="searchstr" class="inputbox" type="text" size="20"><input type="submit" name="submit" value="Go" class="button2" /></form></pre>
</h1></div>
		<div id="topnavbar">
			<ul id="topnavlist">				
		...
		<div class="clear"></div>
		   ...
		   <div id="archive">
		   <h1 class="pageheading" >Archives</h1>
