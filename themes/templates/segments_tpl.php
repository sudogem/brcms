		   ...
		   <div id="column1">
			...
			<h1 class="captions"><span class="dateline">headline news // {DATELINE} (cebu, philippines)</span></h1>
			  ...
			  <div id="headlinesection">
						{PHOTO}
					<div id="column3" > 
							<h1 class="headline">{SEGMENT_TOPIC}</h1>
							<p class="author">{SEGMENT_ANCHOR}</p>
							<p class="text">{SEGMENT_BODY}</p>
							{FULLSTORY}
					</div>
					
					<div>
						<li>
							Air Time Schdule: {SEGMENT_SCHEDULE}
						</li>
					</div>
				</div><!-- headlinesection-->
				<div id="column4">
					<ul id="subsection" >
					  <h1 class="captions">Other Segments</h1>
						{OTHER_SEGMENTS}
					</ul>
						<div class="clear">&nbsp;</div>
						<h1 class="captions">ADVERTISEMENTS</h1>
