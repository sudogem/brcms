		...
		<div class="clear"></div>
		   <div id="column1">
			...
			<div id="contentx"><!-- begin content -->
				<div id="feedback">
					<h1>Feedback </h1>
					<p>Thank you very much for the information you have submitted. <br>This will surely help improve our public service.</p>
					<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;<a href="external_source_int.php">&lt;&lt;&lt;Back</a></div>
				</div>
		    </div>
			<div class="clear">&nbsp;</div>	  
