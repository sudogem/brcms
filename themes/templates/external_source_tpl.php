		   ...
		   <div id="column1">
			...
			<div id="contentx"><!-- begin content -->
				<div id="feedback">
					...
					<p>Contribute To Us. Tell Us What You Know. Be Our Citizen Patrol.</p>



<form method="post" action="external_source.php" name="external_form" onSubmit="confirmSubmit();" >
<table style="float:left;">
		...
		<tr>
			...
			<td><input name="contactNumber" type="text" class="inputbox" size="53" ></td>
		</tr>
		
		<tr>
			<td valign="top">Tell us what you know. Type it here: </td>
			<td><textarea name="externalreport" cols="40" rows="10" class="inputbox"></textarea></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
