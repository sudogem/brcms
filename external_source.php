...
if ( isset($_POST['submit'])) {
	...
	$feedback		= $_POST['feedback'];			#the feedback of the fucking person.
...
#################################################################################################################################
	...
	$source_name	= $_POST['username'];		#this field is optional, contains the name of the external source.
	$emailAddress	= $_POST['emailAddress'];		#the email address of the person who reported an article, optional.
	$contactNumber	= $_POST['contactNumber'];		#the contact number of the person who made a report, also optional.
	$reportDate		= date('Y-m-d');				#the date when the report was subbmitted.					
	$report			= $_POST['externalreport'];				#the actual content.
