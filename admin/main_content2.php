...
else{ // wil display all articles regardless of category so that this user can edit them..
...
if ( $usertype == 'Administrator') {
	...
	$menu .= '<div id="block">';
	$menu .= 	'<a href="../admin/archive_manager.php" ><img src="../admin/images/searchtext.png" alt="" border="0"><p>NewsContent Archive Manager</p></a>';
	$menu .= '</div>';
	...
	$menu .= '<div id="block">';
	$menu .=	'<a href="../admin/report_admin.php" ><img src="../admin/images/addedit.png" alt="" border="0"><p>Admin Report</p></a>';
	$menu .= '</div>';
...
for( $i = 0; $i < count($user_stage); $i++ ){
	switch ($user_stage[$i]->stageID) { // ok lets check his workflow
		...
		case 2:
			...
			$menu .= '<div id="block">';
			$menu .= 	'<a href="../admin/archive_manager.php" ><img src="../admin/images/searchtext.png" alt="" border="0"><p align="center">Article Archive Manager</p></a>';
			$menu .= '</div>';
		...
		case 3:// editing
			$menu .= '<div id="block">';
			$menu .=	'<a href="../admin/view_article_versions.php?stageID=3" ><img src="../admin/images/addedit.png" alt="" border="0"><p>Edit Article</p>- '. $total_writings . ' item(s)-</a>';
			$menu .= '</div>';
		...
		case 4:// evaluating
			$menu .= '<div id="block">';
			$menu .=	'<a href="../admin/view_article_versions.php?stageID=4"><img src="../admin/images/addedit.png" alt="" border="0"><p>Evaluate Article<br></p>- '.$total_editings.' item(s)-</a>';
			$menu .= '</div>';
...
if ( $use_common_menu ) {
	$menu .= '<div id="block">';
	$menu .=	'<a href="../admin/user_profile.php" ><img src="../admin/images/user.png" alt="" width="48" height="48" border="0"><p>My Personal Profile</p></a>';
	$menu .= '</div>';

	$menu .= '<div id="block">';
    ($total_unread_messages > 0) ? 	$menu .= '<a href="../admin/view_messages.php" ><img src="../admin/images/messaging.png" alt="" width="48" height="48" border="0"><p>Messaging</p>- ' . $total_unread_messages . ' unread message(s) - </a>'
	...
	$menu .= '<div id="block">';
	$menu .=	'<a href="../admin/logout2.php" ><img src="../admin/images/frontpage.png" alt=""  border="0"><p>Log-out ('. $username . ')</p></a>';
	$menu .= '</div>';
}

// now start compiling the page..
$tpl = new template_parser( '../templates/main_menu_container.tpl.php' );
$tags = array(
		'{MENU}' => $menu
		);
